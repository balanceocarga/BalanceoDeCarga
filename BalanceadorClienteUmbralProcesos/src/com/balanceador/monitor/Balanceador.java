 ...
 * 
 */
@WebServiceClient(name = "balanceador", targetNamespace = "http://monitor.balanceador.com/", wsdlLocation = "http://localhost:8080/BalanceadorServidorUmbralProcesos/Balanceador?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://localhost:8080/BalanceadorServidorUmbralProcesos/Balanceador?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:8080/BalanceadorServidorUmbralProcesos/Balanceador?wsdl', retrying as a local file");
